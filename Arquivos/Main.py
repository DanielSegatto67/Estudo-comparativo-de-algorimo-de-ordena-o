...
vetor_melhor_caso = preencheVetor(10000) #Preenche um vetor com numeros de 0 até o parametro passado - 1, representa o melhor caso

vetor_caso_medio = preencheVetor(10000)
randomizaVetor(vetor_caso_medio)  #Aleatoriza os elementos de um vetor para representar o caso médio

vetor_pior_caso = preencheVetorDesc(10000) #Preenche um vetor a partir do parametro passado-1 até o 0, representa o pior caso
